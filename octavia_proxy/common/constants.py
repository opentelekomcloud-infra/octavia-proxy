...
# 'UDP_CONNECT'
HEALTH_MONITOR_UDP_CONNECT_V3 = 'UDP_CONNECT'
SUPPORTED_HEALTH_MONITOR_TYPES = lib_consts.SUPPORTED_HEALTH_MONITOR_TYPES
SUPPORTED_HEALTH_MONITOR_TYPES_V3 = (HEALTH_MONITOR_HTTP, HEALTH_MONITOR_HTTPS,
                                     HEALTH_MONITOR_PING, HEALTH_MONITOR_TCP,
                                     HEALTH_MONITOR_UDP_CONNECT_V3)
...
L7POLICY_ACTION_REDIRECT_TO_LISTENER_V3 = 'REDIRECT_TO_LISTENER'
L7POLICY_ACTION_REDIRECT_TO_POOL_V3 = 'REDIRECT_TO_POOL'
SUPPORTED_L7POLICY_ACTIONS_V3 = (L7POLICY_ACTION_REDIRECT_TO_LISTENER_V3,
                                 L7POLICY_ACTION_REDIRECT_TO_POOL_V3)
# 'REGEX'
...
LISTENER_SUPPORTED_PROTOCOLS = lib_consts.LISTENER_SUPPORTED_PROTOCOLS
...
L7POLICY_PROTOCOL_HTTP = 'HTTP'
L7POLICY_PROTOCOL_HTTPS = 'HTTPS'
L7POLICY_PROTOCOL_REQUEST = '${protocol}'
SUPPORTED_L7POLICY_PROTOCOLS = [
    L7POLICY_PROTOCOL_HTTP,
    L7POLICY_PROTOCOL_HTTPS,
    L7POLICY_PROTOCOL_REQUEST
]

L7RULE_COMPARE_TYPE_HOST_NAME = 'HOST_NAME'
SUPPORTED_L7RULE_COMPARE_TYPES_V3 = (
    lib_consts.L7RULE_COMPARE_TYPE_REGEX,
    lib_consts.L7RULE_COMPARE_TYPE_STARTS_WITH,
    L7RULE_COMPARE_TYPE_HOST_NAME,
    lib_consts.L7RULE_COMPARE_TYPE_EQUAL_TO)

L7RULE_TYPE_METHOD = 'METHOD'
L7RULE_TYPE_SOURCE_IP = 'SOURCE_IP'
SUPPORTED_L7RULE_TYPES_V3 = (
    lib_consts.L7RULE_TYPE_HOST_NAME,
    lib_consts.L7RULE_TYPE_PATH,
    L7RULE_TYPE_METHOD,
    L7RULE_TYPE_SOURCE_IP
)
