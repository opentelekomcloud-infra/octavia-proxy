...
class TestHealthMonitorController(base.TestCase):

    def setUp(self):
        super().setUp()

    def test_basic(self):
        controller = health_monitor.HealthMonitorController
        self.assertEqual(
        ...
        self.assertIsNotNone(getattr(controller, '_validate_create_hm'))
        self.assertIsNotNone(getattr(controller, '_validate_update_hm'))
